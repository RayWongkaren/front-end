class HeaderPage extends React.Component {
    render() {
        return(
            <div class="header">
                <h1>Ray Mcdylan Wongkaren</h1>
                <p>
                A chatbot or chatterbot is a software application used to conduct 
                an on-line chat conversation via text or text-to-speech, in lieu
                 of providing direct contact with a live human agent. Chatbot is 
