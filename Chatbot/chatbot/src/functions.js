...
export function response_user(chat, date){
	var html = "<div class='containerbot darker'> <img src='./user.png' alt='Avatar' class='right' style='width:100%;'> <div class='row pt-4'> <div class='col-sm-2'><span class='time-left'>"+date+"</span></div> <div class='col-sm-10 text-end'>"+chat+"</div></div></div>";
	return html;
}

// bot chat replay
export function response_bot(chat, prob, date){
	var html = "<div class='containerbot'> <img src='./bot.png' alt='Avatar' style='width:100%;'> <div class='row'> <div class='col-sm-8 pt-4'>"+chat+"</div> <div class='col-sm-4 pt-2'><span class='time-right'>"+prob+"%</br>"+date+"</span></div> </div> </div>";
	return html;
}
